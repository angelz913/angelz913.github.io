...
const scores = [
    ...
    {
        title: 'Gurenge',
        desc: 'A piano/violin/flute trio arrangement for Demon Slayer opening'
    },
    {
        title: 'The Great Locomotive Chase',
        desc: 'A piano arrangement for my favourite high school concert band piece'
    },
]
...
const Scores = () => {
    return (
        <section id='scores' className='justify-content-center sm:w-10 md:w-9 lg:w-8 xl:w-7 mx-3 mt-5 mb-3 p-5 border-round-md'>
            ...
            <p>Mostly piano arrangements for anime music. There are also some trio arrangements. </p>
